...
export default function ProjectCard({
    ...
    return (
        <div className="p-6 sm:p-10 flex flex-col sm:flex-row gap-4 sm:gap-16 bg-(--secondary) rounded-4xl">
            ...
            <div className="flex flex-col gap-4 sm:w-1/2 relative sm:pt-8 min-h-64">
